export default function Login() {
  return (
    <div className="d-flex flex-column align-items-center justify-content-center min-vh-100">
        {/* TODO: Hay que esperar los otros commits con el footer & navbar así pueda centrar bien el login. */}
      <div className="card w-50 max-w-sm p-4">
        ...
        <div className="card-body">
          <button className="btn btn-LoginGoogle btn-outline-secondary w-100 d-flex align-items-center justify-content-center">
            <svg
