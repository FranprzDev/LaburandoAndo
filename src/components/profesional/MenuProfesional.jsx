...
const MenuProfesional = () => {
  return (
    <nav className="navbar navbar-expand-md menuProfessional bg-body-tertiary d-flex align-items-start w-100 px-2">
      <div className="px-0 container-fluid containerMenu d-flex flex-md-column align-items-start">
        ...
        >
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-end d-flex flex-column flex-grow-1 pe-3">
