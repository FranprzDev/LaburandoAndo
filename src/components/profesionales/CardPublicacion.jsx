...
const CardPublicacion = () => {
  return (
    <div className="card cardPublication pt-2 pt-md-3 px-2 px-md-3 rounded-3 shadow">
      <div className="d-flex flex-column flex-md-row w-100 gap-2 gap-md-4 h-100">
        <div className="h-100 d-flex flex-column justify-content-between align-items-center mt-lg-3">
          <img src={img} alt="" className="imgCardPublication border rounded-circle" />
        </div>
        <div className="d-flex flex-column flex-md-row justify-content-between ">
          <div className="d-flex flex-column gap-1 gap-md-2 pt-2 pb-2 pb-md-3 order-1 order-md-0">
            ...
            <p className="fs-6 text-secondary mb-0">
              Especializada en fotografía de eventos y sesiones fotográficas...
            </p>
            <Link className="d-none d-md-block">seguir leyendo</Link>
          </div>
      ...
      <div className="d-flex justify-content-between align-items-center w-100 pb-2 py-md-3">
        ...
        <Link className="btn rounded-3 btnSeeProfile text-white">
          Ver Perfil de Laura
        </Link>
      </div>
    </div>
