...
const CardPublicacion = () => {
  ...
  return (
    ...
    {publicaciones && publicaciones.length > 0 ? (publicaciones.map((publicacion) => (
      <div key={publicacion._id} className="card cardPublication pt-2 px-2 px-md-3 rounded-3 shadow">
          ...
          <div className="d-flex flex-column gap-1 gap-md-2 pt-2 pb-2 pb-md-3 order-1 order-md-0">
            ...
            <div className="  mt-3 text-center text-md-start w-100">
              <span className=" px-5 py-2 rounded-2 category opacity-50 text-white">
                {publicacion?.category[0] ? publicacion.category[0].name : <>Sin Categoria  </>} 
              </span>
            </div>
